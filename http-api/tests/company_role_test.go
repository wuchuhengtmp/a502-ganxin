 ...
 * 项目管理员获取日类型志列表集成测试
 */
func TestCompanyAdminRoleGetLogTypeList(t *testing.T) {
	q := `
		query {
		  getLogTypeList {
			desc # 类型说明 
 ...
 * 公司管理员获取型钢详情列表集成测试
 */
func TestCompanyAdminRoleGetProjectDetail(t *testing.T) {
	q := `
 ...
 * 公司管理员获取型钢详情列表集成测试
 */
func TestCompanyAdminRoleGetMaintenanceDetail(t *testing.T) {
	q := `
 ...
 * 公司管理员获取订单详情列表集成测试
 */
func TestCompanyAdminRoleGetOrderDetailForBackEnd(t *testing.T) {
	q := `
...
/**
 * 公司管理员获取仓库列表（用于仪表盘）集成测试
 */
func TestCompanyRoleGetSteelSummaryForDashboard(t *testing.T) {
	q := `
...
///**
// * 公司管理员获取项目列表（用于仪表盘）集成测试
// */
//func TestCompanyRoleGetProjectListForDashboard(t *testing.T) {
//	q := `
//		query {
